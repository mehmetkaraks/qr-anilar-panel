...
var FullCalendar = (function (e) {
  ...
  function C(e, t, n, r, o, i, a, s, l, u) {
    ...
    for (n.__k = [], p = 0; p < t.length; p++)
      if (
        null != (v = n.__k[p] = null == (v = t[p]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? g(null, v, null, null, v) : Array.isArray(v) ? g(m, { children: v }, null, null, null) : v.__b > 0 ? g(v.type, v.props, v.key, null, v.__v) : v)
      ) {
        ...
        I(e, v, (h = h || c), o, i, a, s, l, u),
          ...
          null != y
            ? (null == S && (S = y), "function" == typeof v.type && null != v.__k && v.__k === h.__k ? (v.__d = l = w(v, l, e)) : (l = _(e, v, h, D, y, l)), u || "option" !== n.type ? "function" == typeof n.type && (n.__d = l) : (e.value = ""))
      ...
      e: if ("function" == typeof R) {
        if (
          ...
          n.__c
            ...
            : ("prototype" in R && R.prototype.render ? (t.__c = d = new R(S, D)) : ((t.__c = d = new y(S, D)), (d.constructor = R), (d.render = A)), b && b.sub(d), (d.props = S), d.state || (d.state = {}), (d.context = D), (d.__n = r), (p = d.__d = !0), (d.__h = [])),
  ...
  var Qe = ["Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi", "Pazar"];
  function et(e, t) {
    var n = ft(e);
    return (n[2] += 7 * t), ht(n);
  }
  ...
  function Ln(e, t, n, o, i, a) {
    for (
      var s = { title: e.title || "", groupId: e.groupId || "", publicId: e.id || "", url: e.url || "", recurringDef: null, defId: Le(), sourceId: n, allDay: o, hasEnd: i, interactive: e.interactive, ui: kn(e, a), extendedProps: r(r({}, e.extendedProps || {}), t) },
        l = 0,
      ...
      return (
        ...
        (e.prototype.formatRange = function (e, t, n, r) {
          return (
            ...
            n.formatRange({ marker: e, timeZoneOffset: null != r.forcedStartTzo ? r.forcedStartTzo : this.offsetForMarker(e) }, { marker: t, timeZoneOffset: null != r.forcedEndTzo ? r.forcedEndTzo : this.offsetForMarker(t) }, this, r.defaultSeparator)
          );
        }),
        (e.prototype.formatIso = function (e, t) {
          void 0 === t && (t = {});
  ...
  var Ko = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderInnerContent = function () {
          ...
          return (
            e && e.contentKey === n.contentKey ? e && (e.contentVal = t[n.contentKey]) : (e && (e.destroy && e.destroy(), (e = this.customContentInfo = null)), n.contentKey && (e = this.customContentInfo = r({ contentKey: n.contentKey, contentVal: t[n.contentKey] }, n.buildLifecycleFuncs()))),
            e ? [] : t
          );
        }),
            ...
            (d.eventStore = v.eventStore =
              ...
              (i = bt(e.instances, function (e) {
                ...
                return i.allDay || i.recurringDef
                  ? e
                  : r(r({}, e), { range: { start: n.createMarker(t.toDate(e.range.start, e.forcedStartTzo)), end: n.createMarker(t.toDate(e.range.end, e.forcedEndTzo)) }, forcedStartTzo: n.canComputeOffset ? null : e.forcedStartTzo, forcedEndTzo: n.canComputeOffset ? null : e.forcedEndTzo });
              })),
              { defs: o, instances: i }))),
          g))
            m[E] !== y[E] && g[E](y[E], v);
        ...
        (t.prototype.render = function () {
          ...
          return Io(
            _o(
              ...
              _o("div", { className: "fc-popover-header " + t.getClass("popoverHeader") }, _o("span", { className: "fc-popover-title", id: i.titleId }, o.title), _o("span", { className: "fc-popover-close " + t.getIconClass("close"), title: n.closeHint, onClick: this.handleCloseClick })),
            ...
            for (var h = 0, v = t; h < v.length; h++) {
              ...
              b && (l.isRtl ? ((C = 0), (D = c.lefts[m.lastCol] - c.lefts[m.firstCol])) : ((D = 0), (C = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                f.push(
                  _o(
                    "div",
                    { className: "fc-daygrid-event-harness" + (b ? " fc-daygrid-event-harness-abs" : ""), key: E, ref: p ? null : this.segHarnessRefs.createRef(E), style: { visibility: S ? "" : "hidden", marginTop: b ? "" : g.marginTop, top: b ? g.absoluteTop : "", left: D, right: C } },
                    il(m) ? _o(sl, r({ seg: m, isDragging: i, isSelected: y === u, defaultDisplayEventEnd: d }, sr(m, n))) : _o(al, r({ seg: m, isDragging: i, isResizing: a, isDateSelecting: s, isSelected: y === u, defaultDisplayEventEnd: d }, sr(m, n)))
                  )
                );
            }
          return f;
            ...
            return o.weekNumbers && "day" === e
              ? _o(fs, { date: i.start, defaultFormat: xl }, function (e, t, o, i) {
                  return _o(
                    ...
                    _o("div", { className: "fc-timegrid-axis-frame fc-scrollgrid-shrink-frame fc-timegrid-axis-frame-liquid", style: { height: n } }, _o("a", r({ ref: o, className: "fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner" }, a), i))
                  );
                })
          ...
          (t.renderTableRowAxis = function (e) {
            ...
            return _o(Yo, { hookProps: i, classNames: r.allDayClassNames, content: r.allDayContent, defaultContent: Il, didMount: r.allDayDidMount, willUnmount: r.allDayWillUnmount }, function (t, n, r, o) {
              return _o(
                ...
                _o("div", { className: "fc-timegrid-axis-frame fc-scrollgrid-shrink-frame" + (null == e ? " fc-timegrid-axis-frame-liquid" : ""), style: { height: e } }, _o("span", { className: "fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner", ref: r }, o))
              );
            });
          }),
        ...
        (t.prototype.renderSimpleLayout = function (e, t, n) {
          ...
          return (
            ...
            t &&
              ...
              i.push({ type: "body", key: "all-day-divider", outerContent: _o("tr", { role: "presentation", className: "fc-scrollgrid-section" }, _o("td", { className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded") })) })),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return _o(
            ...
            _o("table", { "aria-hidden": !0, className: t.theme.getClass("table"), style: { minWidth: e.tableMinWidth, width: e.clientWidth, height: e.minHeight } }, e.tableColGroupNode, _o(Nl, { slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas }))
          );
        }),
        (t.prototype.componentDidMount = function () {
          this.updateSizing();
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return _o(
          ...
          _o(Hl, { axis: e.axis, dateProfile: e.dateProfile, slatMetas: e.slatMetas, clientWidth: e.clientWidth, minHeight: e.expandRows ? e.clientHeight : "", tableMinWidth: e.tableMinWidth, tableColGroupNode: e.axis ? e.tableColGroupNode : null, onCoords: this.handleSlatCoords }),
          _o($l, {
            cells: e.cells,
            axis: e.axis,
            dateProfile: e.dateProfile,
  ...
  var su = zo({
      ...
      views: { timeGrid: { component: iu, usesMinMaxTime: !0, allDaySlot: !0, slotDuration: "00:30:00", slotEventOverlap: !0 }, timeGridDay: { type: "timeGrid", duration: { days: 1 } }, timeGridWeek: { type: "timeGrid", duration: { weeks: 1 } } },
    }),
    lu = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
    ...
    return (
      ...
      (t.prototype.eventRangeToSegs = function (e, t) {
        ...
        for (n = 0; n < t.length; n += 1)
          if (
            (r = jn(s, t[n])) &&
            ((o = { component: this, eventRange: e, start: r.start, end: r.end, isStart: e.isStart && r.start.valueOf() === s.start.valueOf(), isEnd: e.isEnd && r.end.valueOf() === s.end.valueOf(), dayIndex: n }), u.push(o), !o.isEnd && !l && n + 1 < t.length && s.end < i.add(t[n + 1].start, a))
          ) {
