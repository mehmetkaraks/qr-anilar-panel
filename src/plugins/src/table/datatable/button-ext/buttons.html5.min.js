(function (e) {
    ...
    e.each(b, function (d, c) {
      if (e.isPlainObject(c)) {
        ...
        if (u) {
          ...
          h = 0;
          for (g = v.length; h < g; h++) (f = c.createAttribute(v[h].name.replace(":", "_dt_b_namespace_token_"))), (f.value = v[h].value), b.setAttributeNode(f);
        }
  ...
  if ("undefined" === typeof f || ("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))) r = void 0;
  else {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            f ||
              ("number" === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ...
                : ((m = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")), (f = o(g, "c", { attr: { t: "inlineStr", r: i }, children: { row: o(g, "is", { children: { row: o(g, "t", { text: m }) } }) } }))));
            p.appendChild(f);
          }
          k.appendChild(p);
          h++;
