...
(function (d) {
        ...
        var c = function (e) {
          for (var h = 0, g = e.length; h < g; h++) {
            ...
            if (f.key)
              ...
              else if (d.isPlainObject(f.key) && f.key.key === a && (!f.key.shiftKey || b.shiftKey)) if (!f.key.altKey || b.altKey) if (!f.key.ctrlKey || b.ctrlKey) if (!f.key.metaKey || b.metaKey) (b._buttonsHandled = !0), d(q).click();
  ...
  m.buttonSelector = function (a, b) {
    for (
      var c = [],
        e = function (a, b, c) {
          for (var d, f, h = 0, g = b.length; h < g; h++) if ((d = b[h])) (f = c !== l ? c + h : h + ""), a.push({ node: d.node, name: d.conf.name, idx: f }), d.buttons && e(a, d.buttons, f + "-");
        },
        h = function (a, b) {
          var f,
            g,
  ...
  m.defaults = {
    ...
    name: "main",
    tabIndex: 0,
    dom: { container: { tag: "div", className: "dt-buttons" }, collection: { tag: "div", className: "dt-button-collection" }, button: { tag: "button", className: "dt-button", active: "active", disabled: "disabled" }, buttonLiner: { tag: "span", className: "" } },
  };
  m.version = "1.5.1";
  d.extend(j, {
    collection: {
