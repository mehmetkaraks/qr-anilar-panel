!(function (t, e) {
  ...
  function d(t) {
    var e,
      ...
      i = t && t.ownerDocument,
      r = i.documentElement;
    return void 0 !== t.getBoundingClientRect && (a = t.getBoundingClientRect()), (e = null !== (o = n = i) && o === o.window ? n : 9 === n.nodeType && n.defaultView), { top: a.top + e.pageYOffset - r.clientTop, left: a.left + e.pageXOffset - r.clientLeft };
  }
  function m(t) {
    var e = "";
      ...
      if ((((e = e || {}).wait = e.wait || 0), (e.position = e.position || null), n))
        for (
          ...
          var s = t[a],
            ...
            c = d(s);
          (o.x = c.left + u.x), (o.y = c.top + u.y), (i.pageX = o.x), (i.pageY = o.y), f.show(i, s), 0 <= e.wait && null !== e.wait && setTimeout(r({ type: "mouseup", button: 1 }, s), e.wait);
        }
    }),
    (e.calm = function (t) {
